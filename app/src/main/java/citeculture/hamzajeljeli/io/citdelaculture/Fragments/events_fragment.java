...
import citeculture.hamzajeljeli.io.citdelaculture.Adapters.RecycleViewEventsAdapter;
...
public class events_fragment extends Fragment {
    ...
    private class getAllEvents extends AsyncTask<Void, Void, List<InfoBean>> {
        ...
        protected void onPostExecute(List<InfoBean> infoBeans) {
            if (infoBeans != null) {
                ...
                rv.setAdapter(new RecycleViewEventsAdapter(infoBeans, context));
            } else {
