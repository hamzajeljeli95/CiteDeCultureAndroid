...
import citeculture.hamzajeljeli.io.citdelaculture.detailActualite;
...
public class RecycleViewNewsAdapter extends RecyclerView.Adapter<RecycleViewNewsAdapter.ViewHolder> {
    ...
    public RecycleViewNewsAdapter(List<InfoBean> infoBeans, Context mContext) {
        this.infoBeans = infoBeans;
        this.mContext = mContext;
    }

    @Override
    public RecycleViewNewsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final RecycleViewNewsAdapter.ViewHolder viewHolder, int i) {
        ...
        viewHolder.myCurrView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mContext, detailActualite.class);
